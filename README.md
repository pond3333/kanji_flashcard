# [일본 한자 플래시카드](https://pond3333.github.io/kanji_flashcard/)

**일본 상용한자 2136개를 플래시카드 형태로 공부해봅시다.**

**광고 및 트래커 전혀 없는 _완.전.무.료_ 사이트입니다.**

## 이용 방법

**참고 1: 플래시카드에서 모든 한자는 랜덤으로 등장합니다.**

**참고 2: 모바일/PC에서 되돌아가기 버튼을 누르면 사이트에서 아예 나가집니다. 주의하세요.**

<table width="100%">                                                                                               
    <tr>          
      <td width="50%" align="center"><img src="https://github.com/pond3333/kanji_flashcard/blob/main/Screenshots/1.png?raw=true" width="300"><p>메인 화면입니다. 가나다 순 혹은 JLPT 순으로 공부할 수 있으며, 상용 한자 전체 목록을 볼 수도 있습니다.</p></td>
...
## 추천 공부 방법:
1. 한자를 먼저 종이에 써서 외운다
2. 본 사이트를 통해서 쓴 한자들을 리뷰한다
3. 무한 회독

## 오류 제보

사이트, 한자 등의 오류 제보는 Issues에 올려주세요. 

## Acknowledgements & Credits

All Kakikata GIF and Static images are from [Kanji.gif](https://github.com/jcsirot/kanji.gif) by Jean-Christophe Sirot.
